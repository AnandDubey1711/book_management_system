...
const CreateBooks = () => {
  ...
  const handleSaveBook = () => {
    ...
    setLoading(true);
    axios
      .post(`https://book-manager-15rb.onrender.com/books`, data)
      .then(() => {
        setLoading(false);
  ...
  return (
    <div className='p-4 min-h-screen'>
      <BackButton />
      <h1 className='text-5xl my-4 flex items-center justify-center text-gray-600 font-bold'>Create Book</h1>
      {loading ? <Spinner /> : ''}
      <div className='flex flex-col border-2 border-sky-400 rounded-xl w-[600px] p-4 mx-auto bg-white'>
        ...
        <button className='p-2 bg-sky-300 m-8 rounded-lg hover:bg-sky-600' onClick={handleSaveBook}>
          Save
        </button>
      </div>
    </div>
